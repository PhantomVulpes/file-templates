 ...
 */
const pendingCreatedFiles = new Set();
function activate(context) {
    ...
    context.subscriptions.push(watcher, watcher.onDidCreate((uri) => {
        ...
        if (!(0, templateManager_1.findMatchingTemplate)(fileName)) {
            return;
        }
        ...
        autoApplyTemplate(uri);
    }), vscode.commands.registerCommand('file-templates.newFileFromTemplate', (uri) => newFileFromTemplate(uri)), vscode.commands.registerCommand('file-templates.manageTemplates', () => manageTemplates()), vscode.commands.registerCommand('file-templates.newTemplate', () => newTemplate()));
}
// ---------------------------------------------------------------------------
